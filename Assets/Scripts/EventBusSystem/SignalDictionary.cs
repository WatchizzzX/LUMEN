...
namespace EventBusSystem
{
    public static class SignalDictionary
    {
        public static readonly Dictionary<Type, SignalEnum> TypeToEnum = new()
        {
            ...
            {typeof(EventBusSystem.Signals.GameSignals.SetSettingsLevel), SignalEnum.SetSettingsLevel},
        ...
        public static readonly Dictionary<SignalEnum, Type> EnumToType = new()
        {
            ...
            {SignalEnum.SetSettingsLevel, typeof(EventBusSystem.Signals.GameSignals.SetSettingsLevel)},
        ...
        public static readonly Dictionary<Type, Type> TypeToSerializedType = new()
        {
            ...
            {typeof(EventBusSystem.Signals.GameSignals.SetSettingsLevel), typeof(EventBusSystem.SerializedSignals.SerializedSetSettingsLevel)},
        ...
        public static readonly Dictionary<Type, Type> SerializedTypeToType = new()
        {
            ...
            {typeof(EventBusSystem.SerializedSignals.SerializedSetSettingsLevel), typeof(EventBusSystem.Signals.GameSignals.SetSettingsLevel)},

...
[ExecuteAlways]
public class CableProceduralCurve : BaseCableRenderer
{
    LineRenderer line;
    ...
    [SerializeField,
     Tooltip(
         "Positive keys are applied downward on cable.  Recommended use is to have keys at 0 at the start and end of the curve.")]

...
namespace NullSave.GDTK
{
    ...
    [AutoDoc("Manages mapping Input Actions to their associated icons for the active controller")]
    public class ActionIcons : MonoBehaviour
    {
        ...
        [AutoDoc("Returns the last active device")]
        ...
        [AutoDoc("Gets the icon associated with an action")]
        [AutoDocParameter("Input Action asset")]
        [AutoDocParameter("Name of action to find on Input Action")]
